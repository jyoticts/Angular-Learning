...
export class HelperService {
  ...
  getUrl(urlObj: any): any {
    const _url: string = (ENVIRONMENT.env === 'MOCK' || urlObj.isExcluded) ? 'assets/data'+urlObj.mock : (urlObj.isNonAPI ? ENVIRONMENT.nonAPIBaseUrl+urlObj.rest : ENVIRONMENT.restBaseUrl+urlObj.rest);
